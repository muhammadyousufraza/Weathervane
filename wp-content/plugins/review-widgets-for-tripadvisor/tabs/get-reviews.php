...
<div class="ti-box">
<div class="ti-box-header"><?php echo sprintf(__('Want more %s reviews?', 'trustindex-plugin'), 'Tripadvisor'); ?></div>
<p><?php echo __('Get 100+ REAL Customer reviews, with only 3 minutes of work, without developer knowledge...', 'trustindex-plugin'); ?></p>
<a href="https://wordpress.trustindex.io/collect-reviews/?source=wpcs-tripadvisor" target="_blank" class="ti-btn"><?php echo __('DOWNLOAD OUR FREE GUIDE', 'trustindex-plugin'); ?></a>
</div>
